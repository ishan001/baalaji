...
<div class="collapse navbar-collapse" id="navbar-menu">
    <ul class="nav navbar-nav navbar-right" data-in="slideInUp" data-out="fadeOut">
        ...
        <li @if($menu == 'products')class="active" @endif><a href="/products" class="border">Our Products</a></li>
        <li @if($menu == 'contact')class="active" @endif><a href="/contact-us" class="border">Contact Us</a></li>
    </ul>
</div>