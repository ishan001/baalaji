    ...
    $(window).load(function () {
        ...
        $(".testimonials-wrapper .testimonial-next").click(function () {
            ...
            if ($(this).parent().find('.testimonial.active').next('.testimonial').length == 0) {
                ...
                $(this).parent().find('.testimonial.active').animate({left: '300%'}, {
                    duration: 300, easing: 'easeInOutExpo', complete: function () {

                        $(this).hide().removeClass('active').parent().find('.testimonial').first().addClass('active').css('position', 'relative').css('left', '-300%').fadeIn().animate({left: 0}, {
                            duration: 400,
                ...
                $(this).parent().find('.testimonial.active').animate({left: '300%'}, {
                    duration: 300, easing: 'easeInOutExpo', complete: function () {
                        ...
                        $(this).hide().removeClass('active').css('position', 'absolute').next('.testimonial').addClass('active').css('position', 'relative').css('left', '-300%').fadeIn().animate({left: 0}, {
                            duration: 400,
                            easing: 'easeInOutExpo',
                            complete: function () {
                                $finish = true;
            ...
            if ($(this).parent().find('.testimonial.active').prev('.testimonial').length == 0) {
                ...
                $(this).parent().find('.testimonial.active').animate({left: '-300%'}, {
                    duration: 300, easing: 'easeInOutExpo', complete: function () {
                        ...
                        $(this).hide().removeClass('active').parent().find('.testimonial').last().addClass('active').css('position', 'relative').css('left', '300%').fadeIn().animate({left: 0}, {
                            duration: 400,
                            easing: 'easeInOutExpo',
                            complete: function () {
                                $finish = true;
                ...
                $(this).parent().find('.testimonial.active').animate({left: '-300%'}, {
                    duration: 300, easing: 'easeInOutExpo', complete: function () {
                        ...
                        $(this).hide().removeClass('active').css('position', 'absolute').prev('.testimonial').addClass('active').css('position', 'relative').css('left', '300%').fadeIn().animate({left: 0}, {
                            duration: 400,
                            easing: 'easeInOutExpo',
                            complete: function () {
                                $finish = true;
